 ...
 *
 *	 1. PR_ij = k(1 - H(X|Y_j)/H(X))
 *
 *	 where,
 *	 2. H_X = log k
 *   3. H(X|Y) = H_X_left + H_X_right
 *	 4. H_X_left = c-(c-1)(1-p_j)/c * log(c/c-(c-1)(1-p_j) 
 *	 5. H_X_right = (c-1)*(1-p_j)/c * log(c/(1-p_j) 
 */
public class PrivacyRiskCalculator {
	...
	// 1. transitionProbabilities - but only needs the re-share probability element 2 from the array
